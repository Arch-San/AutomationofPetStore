...
public class userTests {
	...
	public void testGetUserByName()
	{
		...
		Response res=UserEndPoints.readUser(this.userPayload.getUsername()); //getUsername is a getter meth
		res.then().log().all();
	...
	public void testUpdateUserByName()
	{
		...
		Response res= UserEndPoints.updateUser(this.userPayload.getUsername(),userPayload);//parameters are existing username and updated data
		res.then().log().body();
